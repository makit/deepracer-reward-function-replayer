    ...
    for trace_log in completed_trace_logs:
        ...
        with open(log_for_episode, 'w') as f:
            with contextlib.redirect_stdout(f):
                ...
                print("Reward Based on New Reward Function:", round(new_reward, 3))
                ...
                print("Reward Difference:", round(new_reward - analysed_episode['total_reward'], 3))
                print("Discounted Reward Difference 0.9:", round(discounted_9 - analysed_episode['total_discounted_reward_9'], 3))
                print("Discounted Reward Difference 0.99:", round(discounted_99 - analysed_episode['total_discounted_reward_99'], 3))
                print("Discounted Reward Difference 0.999:", round(discounted_999 - analysed_episode['total_discounted_reward_999'], 3))
